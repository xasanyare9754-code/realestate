...
<head>
  ...
  <style type="text/css">
    .authlogin-side-wrapper {
      width: 100%;
      height: 100%;
      background-image: url({{ asset('upload/login.png.png') }});
    }
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Horn<span>Tech</span></a>
                    <h5 class="text-muted fw-normal mb-4">Welcome back! Log in to your account.</h5>
                    
                    <!-- Form Start -->
                    <form method="POST" action="{{ route('admin.login_submit') }}" class="forms-sample">
                      @csrf
                      <div class="mb-3">
